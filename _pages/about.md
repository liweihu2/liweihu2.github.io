...
I'm an applied mathematician working on [inverse problems](https://liweihu2.github.io/research/) in physics-based models, with an emphasis on structure-aware and domain-informed approaches, and current applications to Earth systems. My work focuses on embedding domain-specific structure directly into inverse problem formulations, moving beyond generic regularization toward physically interpretable inference.
